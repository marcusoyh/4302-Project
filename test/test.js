...
contract('DecentralRent', function(accounts) {
    ...
    it('Test accepting a rental offer', async() => {
        ...
        let amountToPay = rentalPrice.toNumber() + deposit;
        
        // Testing for scenario with not enough Ether
        await truffleAssert.reverts( decentralRentInstance.accept_rental_offer(1, { from: renterAddress1, value: amountToPay-1}), "Please transfer enough Eth to pay for rental");
